...
namespace http
{
    namespace exceptions
    {
        ...
        class InvalidDuplicateHeaders : public std::runtime_error
        {
        public:
            InvalidDuplicateHeaders(const std::string &message = "")
                : std::runtime_error("HTTP: Invalid duplicate headers" + (message.empty() ? "" : "\n" + message)) {}
        };
        ...
        class StatusLineTooLong : public std::runtime_error
        {
        public:
            StatusLineTooLong(const std::string &message = "")
